...
-- 5. 创建推送频率配置表
DROP TABLE IF EXISTS `push_frequency`;
CREATE TABLE `push_frequency` (
    `id` BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
-- 6. 创建高潜线索表
DROP TABLE IF EXISTS `high_potential_lead`;
CREATE TABLE `high_potential_lead` (
    `id` BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
